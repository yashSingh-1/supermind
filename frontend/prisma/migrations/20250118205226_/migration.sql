...
-- CreateEnum
CREATE TYPE "MEDIATYPE" AS ENUM ('IMAGE', 'VIDEO', 'CAROSEL_ALARM');
...
-- CreateTable
CREATE TABLE "KeywordPrompt" (
    "id" TEXT NOT NULL,
    "keyword" TEXT NOT NULL,

    CONSTRAINT "KeywordPrompt_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "KeywordPrompt_id_key" ON "KeywordPrompt"("id");
